...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  levi45emulator_1.1    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2611/refs/heads/main/enigma2-plugin-extensions-levi45emulator_1.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45emulator_1.1_all.ipk"
