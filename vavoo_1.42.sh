...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing  vavoo_1.42           #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2611/refs/heads/main/enigma2-plugin-extensions-vavoo_1.42_all.ipk"
IPK_NAME="eenigma2-plugin-extensions-vavoo_1.42_all.ipk"
