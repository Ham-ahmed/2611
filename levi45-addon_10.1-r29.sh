...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  levi45-addon_10.1-r2     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2611/refs/heads/main/enigma2-plugin-extensions-levi45-addon_10.1-r29_all.ipk"
IPK_NAME="eenigma2-plugin-extensions-levi45-addon_10.1-r29_all.ipk"
